...
export const BROADCOM_INDEX_PATH = "jandi-notion/broadcom-index.json";
export const BROADCOM_STATE_PATH = "jandi-notion/broadcom-state.json";
export const BROADCOM_PLAN_PREFIX = "jandi-notion/broadcom-runs";
export const BROADCOM_BODY_STATE_PATH = "jandi-notion/broadcom-body/state.json";
export const BROADCOM_BODY_MANIFEST_PATH = "jandi-notion/broadcom-body/manifest.json";
export const BROADCOM_BODY_CHUNK_PREFIX = "jandi-notion/broadcom-body/chunks";
export const BROADCOM_TITLE_STATE_PATH = "jandi-notion/broadcom-title/state.json";
export const BROADCOM_TITLE_PLAN_PATH = "jandi-notion/broadcom-title/plan.json";
export const BROADCOM_TITLE_CHUNK_PREFIX = "jandi-notion/broadcom-title/chunks";
export const BROADCOM_DAILY_STATE_PATH = "jandi-notion/broadcom-daily/state.json";
export const BROADCOM_DAILY_PLAN_PATH = "jandi-notion/broadcom-daily/plan.json";
